...
from src.path_execution.thruster_utils import transform_to_thrust
# from src.path_execution import pid
from src.control_tasks.utils import get_yaw
from src.path_execution.visualizations import path_visualizer
import time
import math
import rospy
...
def execute(waypoints, des_lin_vel=1.0, max_ang_vel=1.6, lookahead=1.0, sec=400):
    ...
    rospy.loginfo("Unsmoothed waypoint list: " + str(waypoints))
    waypoints = auto_smooth(waypoints, np.pi/3)
